            ...
            <div id={styles.head_bar}>
                <div id={styles.title}>
                    ...
                    <div id={styles.title_info} style={{ fontSize: '13px' }}>
                        <span className={styles.title_info_time} style={{ color: '#6a737c' }}>Time </span>
                        <span id={styles.title_info_time} className="title_info_time" style={{ paddingRight: '8px' }}>{new Date(this.questionData.datetime).toDateString() }</span>
