...
namespace ForumApi.Services
{
    public class DataService
    {
        ...
        public static readonly string[] bengaliStopWords = {
            ...
            "কে","কাকে","ঐটি","এইগুলো","ঐগুলো","এইগুলা","ঐগুলা","ছিল","হই","হবে","হয়েছে","হয়","হইত",
            "হচ্ছে","আছে","এবং","কিন্তু","যদি",
            "অথবা","কারণ","কারন","কারনে","যেহেতু","যতক্ষন","পর্যন্ত","যখন","এর","দ্বারা","দারা","জন্য","সাথে","সম্পর্কে","বিরোদ্ধে","মধ্যে","হইতে",
            "ভিতরে","থেকে",
            "কিভাবে","কীভাবে","এখানে","সেখানে","কেন",
            "শুধু","তাই"
        };
